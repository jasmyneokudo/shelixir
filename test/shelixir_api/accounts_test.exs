defmodule ShelixirApi.AccountsTest do
  use ShelixirApi.DataCase

  alias ShelixirApi.Accounts

  describe "accounts" do
    alias ShelixirApi.Accounts.Account

    import ShelixirApi.AccountsFixtures
